 ...
 * ("http://localhost:8080/def/crs/EPSG/0/4269/browse.jsp")
 *
...
public class SecoreBrowseCRSMetadataTest extends SecoreAbstractSectionWebPageTest {
    ...
    public SecoreBrowseCRSMetadataTest() {
        super();
        this.testURL = Config.SECORE_CONTEXT_PATH + "crs/EPSG/0/4269/browse.jsp";
    ...
    public void runTest(WebDriver webDriver) throws InterruptedException, IOException {
        ...
        log.info("Testing login with ****wrong*** username, password in admin page: crs/EPGS/0/4269/browse.jsp URI...");
        ...
        log.info("Testing login with username, password in admin page: crs/EPGS/0/4269/browse.jsp URI...");
        ...
        log.info("Testing browse CRS metadata from EPSG:4269 URI...");
        ...
        log.info("Testing validate browsed CRS metadata from EPSG:4269 URI...");
        ...
        log.info("Testing add CRS metadata to user database from EPSG:4269 URI...");        
