...
TEST_STRUCT_TYPE="CREATE TYPE $STRUCT_TYPE_NAME UNDER STRUCT { red char, green char, blue char }"
TEST_MARRAY_DIM_TYPE="CREATE TYPE $MARRAY_DIM_TYPE_NAME UNDER MARRAY { $STRUCT_TYPE_NAME } , 2"
TEST_MARRAY_DOM_TYPE="CREATE TYPE $MARRAY_DOM_TYPE_NAME UNDER MARRAY { $STRUCT_TYPE_NAME } , [0:10,0:10]"
TEST_SET_TYPE="CREATE TYPE $SET_TYPE_NAME UNDER SET { $MARRAY_DIM_TYPE_NAME }"
TEST_SET_TYPE_NULL_VALUES="CREATE TYPE $SET_TYPE_NAME_NULL_VALUES UNDER SET { $MARRAY_DOM_TYPE_NAME } NULL VALUES [1:3]"
