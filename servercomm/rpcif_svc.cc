...
//end patched by awk 4
	union {
		...
		ExecuteQueryParams rpcexecuteinsert_1_arg;
	} argument;
	char *result;
...
//end patched by awk 5
	...
	case RPCEXECUTEINSERT:
		_xdr_argument = (xdrproc_t) xdr_ExecuteQueryParams;
		_xdr_result = (xdrproc_t) xdr_ExecuteQueryRes;
		local = (char *(*)(char *, struct svc_req *)) rpcexecuteinsert_1_svc;
		break;
...
//patched by awk 2.1
		...
		{
		retvalTxt = strdup(e.serialiseError().c_str());
		u_short temp = 42;
