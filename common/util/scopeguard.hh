...
// Credits: https://github.com/ricab/scope_guard

#ifndef SCOPE_GUARD_HH_
#define SCOPE_GUARD_HH_
...
template <typename Callback>
common::detail::scope_guard<Callback>::scope_guard(Callback &&callback) noexcept(std::is_nothrow_constructible<Callback, Callback &&>::value)
...
template <typename Callback>
common::detail::scope_guard<Callback>::scope_guard(scope_guard &&other) noexcept(std::is_nothrow_constructible<Callback, Callback &&>::value)
...
template <typename Callback>
inline auto common::detail::make_scope_guard(Callback &&callback) noexcept(std::is_nothrow_constructible<Callback, Callback &&>::value)
    -> detail::scope_guard<Callback>
{
    return detail::scope_guard<Callback>{std::forward<Callback>(callback)};
}

#endif /* SCOPE_GUARD_HH_ */
