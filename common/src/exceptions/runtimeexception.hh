...
{
/**
 * @brief The RuntimeException class defines a type of object to be thrown as exception.
 *  It reports errors that are due to events beyond the scope of the program and can not be easily predicted.
 */
class RuntimeException : public common::Exception
{
public:
    /**
     * @brief RuntimeException Constructs the exception object with whatArg as explanatory string that can be accessed through what().
