...
r_Sinterval &r_Sinterval::union_of(const r_Sinterval &interval1,
...
r_Sinterval &r_Sinterval::difference_of(const r_Sinterval &interval1,
                                        const r_Sinterval &interval2)
{
...
r_Sinterval &r_Sinterval::intersection_of(const r_Sinterval &interval1,
        const r_Sinterval &interval2)
{
...
r_Sinterval r_Sinterval::calc_union(const r_Sinterval &a,
