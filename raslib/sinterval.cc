...
void
r_Sinterval::set_low(r_Range newLow)
{
...
void
r_Sinterval::set_high(r_Range newHigh)
{
...
void
r_Sinterval::set_interval(r_Range newLow, r_Range newHigh)
{
    if (newLow > newHigh)
    {
        LERROR << "Invalid interval: lower bound (" << newLow
