...
int main()
{
    ...
    cout << "   local oid..: " << oid1.get_local_oid() << endl
         << endl;
    ...
    cout << "   local oid..: " << oid2.get_local_oid() << endl
         << endl;
    ...
    cout << "   local oid..: " << oid3.get_local_oid() << endl
         << endl;
    ...
    cout << "   local oid..: " << oid4.get_local_oid() << endl
         << endl;
    ...
    cout << "   local oid..: " << oid5.get_local_oid() << endl
         << endl;
    ...
    cout << "   local oid..: " << oid6.get_local_oid() << endl
         << endl;
    ...
    cout << "   local oid..: " << oid7.get_local_oid() << endl
         << endl;
    ...
    cout << "   local oid..: " << oid8.get_local_oid() << endl
         << endl;
    ...
    cout << "   local oid..: " << oid9.get_local_oid() << endl
         << endl;
    ...
    cout << "   local oid..: " << oid10.get_local_oid() << endl
         << endl;

    cout << "Compare r_OId( \"testSystem1|testBase|99\") < r_OId( \"testSystem2|testBase|99\")" << endl;
    cout << (r_OId("testSystem1|testBase|99") < r_OId("testSystem2|testBase|99")) << endl
         << endl;

    cout << "Compare r_OId( \"testSystem|testBase1|99\") < r_OId( \"testSystem|testBase2|99\")" << endl;
    cout << (r_OId("testSystem|testBase1|99") < r_OId("testSystem|testBase2|99")) << endl
         << endl;

    cout << "Compare r_OId( \"testSystem|testBase|99\") < r_OId( \"testSystem|testBase|100\")" << endl;
    cout << (r_OId("testSystem1|testBase|99") < r_OId("testSystem2|testBase|100")) << endl
         << endl;
    ...
    cout << "   local oid..: " << oid11.get_local_oid() << endl
         << endl;
    ...
    cout << "   local oid..: " << oid12.get_local_oid() << endl
         << endl;
