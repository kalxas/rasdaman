 ...
 *
 */
#ifndef RASNET_SRC_SOCKETS_SERVER_CLIENTPOOL_HH_
#define RASNET_SRC_SOCKETS_SERVER_CLIENTPOOL_HH_
...
#include "../../../src/sockets/common/peerstatus.hh"
...
public:
     ...
     */
    void addClient(std::string clientId, boost::int32_t period, boost::int32_t retries);

    boost::int32_t getMinimumPollPeriod() const;
    /**
     ...
     * server socket through which it sent the message.
     */
    void resetClientStatus(std::string clientId);
     ...
     */
    void pingAllClients(zmq::socket_t& socket);
     ...
     */
    bool isClientAlive(std::string clientId);
...
#endif /* RASNET_SOCKETS_SERVER_CLIENTPOOL_HH_ */
