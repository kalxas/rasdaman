...
int main()
{
    ...
    cout << "Cardinality of empty collection 'a': " << a.cardinality() << endl
         << endl;
    ...
    cout << "Does 'a' contain element '500' (1=TRUE/0=FALSE)? " << a.contains_element(&d) << endl
         << endl;
    ...
    cout << "Testing assignment operator on r_Collections." << endl
         << "(creating r_Collection 'b' that is equal to 'a'.)" << endl;
    r_Collection<r_Ref_Any> b;
    b = a;
    cout << "Cardinality of 'b': " << b.cardinality() << endl
         << endl;

    cout << "Testing copy constructor of r_Collection." << endl
         << "(creating r_Collection 'c' that is equal to 'a'.)" << endl;
