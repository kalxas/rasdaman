...
module ows {
    export class OperationsMetadata {
        ...
        public constructor(source:rasdaman.common.ISerializedObject) {
            ...
            source.getChildrenAsSerializedObjects("ows:Operation").forEach(o=> {
                this.Operation.push(new Operation(o));
            });
            ...
            if (source.doesElementExist("ows:ExtendedCapabilities")) {
                this.ExtendedCapabilities = new ExtendedCapabilities(source.getChildAsSerializedObject("ows:ExtendedCapabilities"));
            }
        }
    }
}