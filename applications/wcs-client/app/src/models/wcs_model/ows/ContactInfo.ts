...
module ows {
    export class ContactInfo {
        ...
        public hoursOfService:string;
        public contactInstructions:string;

        public constructor(source:rasdaman.common.ISerializedObject) {
            rasdaman.common.ArgumentValidator.isNotNull(source, "source");

            if (source.doesElementExist("ows:Phone")) {
                this.phone = new Phone(source.getChildAsSerializedObject("ows:Phone"));
            }

            if (source.doesElementExist("ows:Address")) {
                this.address = new Address(source.getChildAsSerializedObject("ows:Address"));
            }

            if (source.doesElementExist("ows:OnlineResource")) {
                this.onlineResource = new OnlineResource(source.getChildAsSerializedObject("ows:OnlineResource"));
            }
