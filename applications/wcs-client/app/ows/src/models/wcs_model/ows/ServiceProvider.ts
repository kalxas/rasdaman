...
module ows {
    export class ServiceProvider {
        ...
        public providerSite:OnlineResource;
        ...
        public constructor(source:rasdaman.common.ISerializedObject) {
            ...
            if (source.doesElementExist("ows:ProviderSite")) {
                this.providerSite = new OnlineResource(source.getChildAsSerializedObject("ows:ProviderSite"));
            }

            if (source.doesElementExist("ows:ServiceContact")) {
                this.serviceContact = new ServiceContact(source.getChildAsSerializedObject("ows:ServiceContact"));
            }
        }
    }
}