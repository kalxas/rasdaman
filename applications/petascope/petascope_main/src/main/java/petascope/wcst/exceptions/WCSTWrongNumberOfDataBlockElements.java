 ...
 */
public class WCSTWrongNumberOfDataBlockElements extends WCSTException {

    public WCSTWrongNumberOfDataBlockElements() {
        super(ExceptionCode.WCSTWrongNumberOfDataBlockElements, EXCEPTION_TEXT);
    }
