...
public class SubsetDimensionParserService {
    ...
    public static List<AbstractSubsetDimension> parseSubsets(String[] subsets) throws WCSException {
        ...
        for (String subset : subsets) {
            ...
            // Parse the dimensionName and dimensionCRS (optional)
            ...
            // NOTE: WCS trimming must be a,b not a:b as in WCPS, also it is not a string datetime ("2016-02-03+03:02:05")
            if (intervalTmp.contains(":") && !intervalTmp.contains("\"")) {
                throw new WCSException(ExceptionCode.InvalidRequest, "Trimming subset in WCS must follow this syntax 'lowerBound,upperBound', given '" + intervalTmp + "'.");
            }
