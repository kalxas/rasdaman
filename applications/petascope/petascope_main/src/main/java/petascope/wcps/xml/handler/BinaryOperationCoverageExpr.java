...
public class BinaryOperationCoverageExpr extends AbstractRasNode {
    ...
    public BinaryOperationCoverageExpr(Node node, WCPSXmlQueryParsingService xq) throws WCPSException, SecoreException {
    ...
    public String toAbstractSyntax() {
        ...
        if (operation.equals(WcpsConstants.MSG_OVERLAY)) {
            ...
            ret = " " + second.toAbstractSyntax() + " " + RASQL_OVERLAY + " " + first.toAbstractSyntax() + " ";
        } else if (operation.equals(WcpsConstants.MSG_POW)) {
            ret = RASQL_POW + "(" + first.toAbstractSyntax() + ", " + second.toAbstractSyntax() + ")";
        } else {
            ret = " ( " + first.toAbstractSyntax() + " " + operation + " " + second.toAbstractSyntax() + ") ";
        }
        return ret;
    }
}
