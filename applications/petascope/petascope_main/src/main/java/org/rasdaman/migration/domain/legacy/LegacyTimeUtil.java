...
public class LegacyTimeUtil {
    ...
    // Logger
    private static Logger log = LoggerFactory.getLogger(LegacyTimeUtil.class);
     ...
     */
    public static boolean isOrderedTimeSubset(String timestampLo, String timestampHi) throws Exception {
        ...
        try {
            ...
            throw new Exception("Cannot convert input datetimes to numeric time coordinates: duration exceeds a 64 bit long.", ex);
        }
     ...
     * @throws PetascopeException
     */
    public static String plus(String timestamp, Double coefficient, String timeResolution) throws Exception {
        DateTime dt = isoFmt.parseDateTime(fix(timestamp));
     ...
     * @throws PetascopeException
     */
    public static String coordinate2timestamp(Double numCoordinate, String datumOrigin, String timeResolution) throws Exception {
        return LegacyTimeUtil.plus(datumOrigin, numCoordinate, timeResolution);
    }
     ...
     */
    public static Long getMillis(CrsDefinition crsDefinition) throws Exception {
     ...
     * @throws PetascopeException
     */
    private static Long getMillis(String ucumAbbreviation) throws Exception {
        Long millis = timeUomsRegistry.get(ucumAbbreviation);
        if (null == millis) {
            throw new Exception("Unsupported temporal Unit of Measure [" + ucumAbbreviation + "].");
        }
        return millis;
    }
