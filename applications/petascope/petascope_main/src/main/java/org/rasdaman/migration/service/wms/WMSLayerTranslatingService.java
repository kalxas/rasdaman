...
public class WMSLayerTranslatingService {
     ...
     */
    public Layer create(LegacyWMSLayer legacyLayer) throws PetascopeException, SecoreException, WMSException {;
        ...
        Coverage coverage = this.coverageRepostioryService.readCoverageFullMetadataByIdFromCache(layerName);
        if (coverage == null) {
     ...
     * @return
     */
    private BoundingBox createBoundingBox(Coverage coverage) throws PetascopeException, SecoreException, WMSException {
