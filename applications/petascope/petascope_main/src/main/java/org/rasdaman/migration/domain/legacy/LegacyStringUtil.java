...
public class LegacyStringUtil {
    ...
    private static String escapeAmpersands(String aString) {
        return aString.replace("&", "&" + LegacyXMLSymbols.PREDEFINED_ENTITY_AMPERSAND + ";");
    }
    ...
    private static String escapeApostrophes(String aString) {
        return aString.replace("'", "&" + LegacyXMLSymbols.PREDEFINED_ENTITY_APOSTROPHE + ";");
    }
    ...
    private static String escapeLessThanSigns(String aString) {
        return aString.replace("<", "&" + LegacyXMLSymbols.PREDEFINED_ENTITY_LESSTHAN_SIGN + ";");
    }
    ...
    private static String escapeGreaterThanSigns(String aString) {
        return aString.replace(">", "&" + LegacyXMLSymbols.PREDEFINED_ENTITY_GREATERTHAN_SIGN + ";");
    }
    ...
    private static String escapeQuotes(String aString) {
        return aString.replace("\"", "&" + LegacyXMLSymbols.PREDEFINED_ENTITY_QUOTES + ";");
    }
