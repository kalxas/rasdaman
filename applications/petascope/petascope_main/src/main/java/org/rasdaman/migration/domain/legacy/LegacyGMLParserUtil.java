 ...
 */
public class LegacyGMLParserUtil {

    private static final org.slf4j.Logger log = LoggerFactory.getLogger(LegacyGMLParserUtil.class);

    public static String parseCoverageType(Element root) throws Exception {
        String rootName = root.getLocalName();
        if (rootName.equals(LegacyXMLSymbols.LABEL_GRID_COVERAGE)) {
            return LegacyXMLSymbols.LABEL_GRID_COVERAGE;
        } else if (rootName.equals(LegacyXMLSymbols.LABEL_RECTIFIED_GRID_COVERAGE)) {
            return LegacyXMLSymbols.LABEL_RECTIFIED_GRID_COVERAGE;
        } else if (rootName.equals(LegacyXMLSymbols.LABEL_REFERENCEABLE_GRID_COVERAGE)) {
            return LegacyXMLSymbols.LABEL_REFERENCEABLE_GRID_COVERAGE;
        } else {
...
//     * @throws WCSException
//     */
//    public static Element parseDomainSet(Element root) throws Exception {
...
//     */
//    public static Element parseGridType(Element domainSet) throws Exception {
