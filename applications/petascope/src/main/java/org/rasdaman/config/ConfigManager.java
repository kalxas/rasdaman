...
public class ConfigManager {
    ...
    public static final String WCST_VERSION = "1.1.4";
    ...
    public static String PETASCOPE_DATASOURCE_DRIVER;
    ...
    public static String LEGACY_DATASOURCE_DRIVER = "org.postgresql.Driver";
    ...
    private void initSettings() throws RasdamanException {
        ...
        // Datasource driver is a part of URL already (e.g: jdbc:postgresql)
        String[] tmp = PETASCOPE_DATASOURCE_URL.split(":");
        PETASCOPE_DATASOURCE_DRIVER = tmp[0] + ":" + tmp[1];
        ...
        log.info("Metadata Driver     : " + PETASCOPE_DATASOURCE_DRIVER);
