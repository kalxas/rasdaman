...
import petascope.wcst.exceptions.WCSTInvalidUpdateOnIrregularAxisException;
...
public class IrregularAxis extends GeoAxis {
     ...
     * @return
     * @throws
     * petascope.wcst.exceptions.WCSTInvalidUpdateOnIrregularAxisException
     */
    public boolean validateCoefficient(BigDecimal coefficient) throws WCSTInvalidUpdateOnIrregularAxisException {
