 ...
 */
public abstract class LegacyAbstractDataComponent extends LegacyAbstractSWEIdentifiable {
     ...
     */
    protected LegacyAbstractDataComponent() {
        super();
        definitionURI = "";
    }
    /**
     ...
     * @param definition
     */
    protected LegacyAbstractDataComponent(String definition) {
        super();
     ...
     * @param definition
     */
    protected LegacyAbstractDataComponent(String label, String description, String definition) {
