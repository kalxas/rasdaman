 ...
 */
public abstract class LegacyAbstractSimpleComponent extends LegacyAbstractDataComponent {
     ...
     */
    private final List<LegacyNilValue> nilValues;
    /**
     ...
     */
    protected LegacyAbstractSimpleComponent() {
        super();
        nilValues = new ArrayList<LegacyNilValue>(0);
    }
    /**
     ...
     * @param nils
     */
    protected LegacyAbstractSimpleComponent(String label, String description, String definition, List<LegacyNilValue> nils) {
        super(label, description, definition);
        nilValues = new ArrayList<LegacyNilValue>(nils.size());
        for (LegacyNilValue nil : nils) {
            nilValues.add(nil);
        }
    }
     ...
     */
    public Iterator<LegacyNilValue> getNilValuesIterator() {
        return nilValues.iterator();
    }
    
    public List<LegacyNilValue> getNilValues() {
