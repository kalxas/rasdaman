...
import static org.rasdaman.migration.legacy.LegacyXMLSymbols.*;
 ...
 */
public class LegacyQuantity extends LegacyAbstractSimpleComponent {
     ...
     */
    private final LegacyAllowedValue constraint;
    /**
     ...
     * @param unitOfMeasure
     */
    public LegacyQuantity(String unitOfMeasure) {
        super();
        uom = unitOfMeasure;
        constraint = null;
    }
     ...
     * @param allowedValues
     */
    public LegacyQuantity(String unitOfMeasure, LegacyAllowedValue allowedValues) {
        super();
        uom = unitOfMeasure;
     ...
     * @param allowedValues
     */
    public LegacyQuantity(String label, String description, String definition, List<LegacyNilValue> nils, String unitOfMeasure, LegacyAllowedValue allowedValues) {
    ...
    public List<String> getAllowedValues() {
        ...
        for (LegacyRealPair interval:this.constraint.getIntervals()) {
            String value = interval.getMin() + " " + interval.getMax();
            values.add(value);
        }
    ...
    public String toGML() {
        ...
        // NIL values
        Iterator<LegacyNilValue> nilIt = getNilValuesIterator();
        if (nilIt.hasNext()) {
