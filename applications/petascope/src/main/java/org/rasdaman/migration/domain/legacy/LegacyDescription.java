...
import org.rasdaman.migration.domain.legacy.LegacyPair;
...
public class LegacyDescription {
    ...
    public void addKeywordGroup(List<LegacyPair<String, String>> keyAndLang) {
        serviceKeywords.add(new KeywordsGroup(keyAndLang));
    }
    public void addKeywordGroup(List<LegacyPair<String, String>> keyAndLang, String type) {
        serviceKeywords.add(new KeywordsGroup(keyAndLang, type));
    }
    public void addKeywordGroup(List<LegacyPair<String, String>> keyAndLang, String type, String codeSpace) {
    ...
    */
    public class KeywordsGroup {
        ...
        private List<LegacyPair<String, String>> keyValues;
        private String keyType;
        private String keyTypeCodeSpace;

        // Constructors: at least 1 keyword required, to avoid let inconsistent keyword groups
        KeywordsGroup(List<LegacyPair<String, String>> keysAndLangs) {
            keyValues = new ArrayList<LegacyPair<String, String>>();
            for (LegacyPair<String, String> keyAndLang : keysAndLangs) {
                keyValues.add(LegacyPair.of(
                                  keyAndLang.fst,
                                  ((null == keyAndLang.snd) ? "" : keyAndLang.snd))
                             );
            }
        }
        KeywordsGroup(List<LegacyPair<String, String>> keysAndLangs, String type) {
            this(keysAndLangs);
            keyType = type;
        }
        KeywordsGroup(List<LegacyPair<String, String>> keysAndLangs, String type, String codeSpace) {
            this(keysAndLangs, type);
            keyTypeCodeSpace = codeSpace;
        }

        // Getters/Setters
        public List<LegacyPair<String, String>> getValues() {
            return keyValues;
        }
        public void addValue(String newKey) {
            keyValues.add(LegacyPair.of(newKey, ""));
        }
        public void addValue(String newKey, String lang) {
            keyValues.add(LegacyPair.of(newKey, lang));
        }
        //
