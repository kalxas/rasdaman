...
import org.rasdaman.migration.legacy.LegacyStringUtil;

/**
 *
 * @author <a href="mailto:p.campalani@jacobs-university.de">Piero Campalani</a>
 */
public abstract class LegacyAbstractSWEIdentifiable {
     ...
     */
    protected LegacyAbstractSWEIdentifiable() {
        label         = "";
        description   = "";
    }
    /**
     ...
     */
    protected LegacyAbstractSWEIdentifiable(String lab, String descr) {
        label         = lab;
        description   = descr;
    }
    ...
    public String getLabel() {
        ...
        if (label == null || LegacyStringUtil.isRandomString(LegacyDbMetadataSource.QUANTITY_LABEL, label)) {
            return "";
        }
        return label;
    }
