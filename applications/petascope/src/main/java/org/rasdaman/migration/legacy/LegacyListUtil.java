...
public class LegacyListUtil {
    ...
    public static <T> List<T> tail(List<T> l) {
        ...
        return LegacyListUtil.sublist(l, 1, l.size() - 1);
    }
    ...
    public static <T> String printList(List<T> l, String FS) {
        ...
        if (l.size() > 0) {
            ...
            for (int i = 0; i < l.size() - 1; i++) {
                if (isBigDecimal) {
                    sb.append(LegacyBigDecimalUtil.stripDecimalZeros((BigDecimal)l.get(i)));
                } else {
                    sb.append(l.get(i));
                }
                sb.append(FS);
            ...
            if (isBigDecimal) {
                sb.append(LegacyBigDecimalUtil.stripDecimalZeros((BigDecimal)l.get(l.size() - 1)));
            } else {
