...
public class LegacyPair<A, B> {
     ...
     */
    public static <A, B> LegacyPair<A, B> of(A a, B b) {
        return new LegacyPair<A, B>(a, b);
    }

    public LegacyPair(A fst, B snd) {
        this.fst = fst;
        this.snd = snd;
    }
    ...
    public boolean equals(Object other) {
        return other instanceof LegacyPair && equals(fst, ((LegacyPair) other).fst) && equals(snd, ((LegacyPair) other).snd);
    }
