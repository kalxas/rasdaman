...
public class LegacyWMSLayerMainService {
     ...
     * @return
     */
    private Layer convertToInsert(LegacyWMSLayer legacyWMSLayer) throws SQLException, PetascopeException, SecoreException, SecoreException, WMSInvalidDimensionalityException {
     ...
     */
    public boolean layerNameExist(String legacyLayerName) throws WMSLayerNotExistException {
     ...
     */
    public void persist(LegacyWMSLayer legacyWMSLayer) throws SQLException, PetascopeException, SecoreException, WMSInvalidDimensionalityException {
        ...
        if (layer != null) {
            ...
            log.info("WMS layer: " + layer.getName() + " is persisted to database.");
        }
    }
}
