...
public class LegacyServiceContact {

    private String individualName;
    private String positionName;
    private LegacyContactInfo contactInfo;
    private String role;

    // Constructor
    LegacyServiceContact() {
        contactInfo = new LegacyContactInfo();
    }
    ...
    //
    public LegacyContactInfo getContactInfo() {
        return contactInfo;
    }
    //
