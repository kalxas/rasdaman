...
public abstract class AbstractController {
    ...
    /**
     * From the GET/POST request query string to a map of keys, values which is
     * encoded or raw (POST only).
     *
     * @param queryString
     * @return
     * @throws Exception
     */
    protected Map<String, String[]> buildRequestKvpParametersMap(String queryString) throws Exception {
        if (queryString == null) {
            queryString = "";
        }
