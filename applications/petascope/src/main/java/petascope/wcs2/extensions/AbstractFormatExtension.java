...
public abstract class AbstractFormatExtension implements FormatExtension {
    ...
    public class CrsProperties {
        ...
        protected CrsProperties(double xMin, double xMax, double yMin, double yMax, String crs) {
            lowX  = xMin;
            highX = xMax;
            lowY  = yMin;
            highY = yMax;
        ...
        protected CrsProperties(String xMin, String xMax, String yMin, String yMax, String crs) {
