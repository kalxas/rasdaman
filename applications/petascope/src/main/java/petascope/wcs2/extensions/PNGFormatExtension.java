 ...
 */
public class PNGFormatExtension extends AbstractFormatExtension {

    /* Member */
    GdalParameters gdalParams;
    private static final Logger log = LoggerFactory.getLogger(PNGFormatExtension.class);
    ...
    public Response handle(GetCoverageRequest request, DbMetadataSource meta)
        ...
        if (m.getGridDimension() != 2 || m.hasIrregularAxis() || !(WcsUtil.isGrid(m.getCoverageType()))) {
            throw new WCSException(ExceptionCode.InvalidRequest, "The PNG format extension "
    ...
    public String getExtensionIdentifier() {
        return ExtensionsRegistry.PNG_IDENTIFIER;
    }
