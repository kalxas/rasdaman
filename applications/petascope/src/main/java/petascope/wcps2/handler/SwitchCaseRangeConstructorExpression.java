...
public class SwitchCaseRangeConstructorExpression {
    ...
    public static WcpsResult handle(List<WcpsResult> booleanResults, List<WcpsResult> rangeResults) {
    ...
    private static final String TEMPLATE_WHEN_THEN = "WHEN ( $booleanExpr ) THEN ( $rangeExpr )";
    // but only one default
    private static final String TEMPLATE_ELSE = "ELSE ( $rangeExpr )";
