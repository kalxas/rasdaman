...
CREATE TABLE ps_telephone (
    ...
    voice      text[] NULL, -- //ows:ServiceProvider/ows:ServiceContact/ows:ContactInfo/ows:Phone/ows:Voice
    facsimile  text[] NULL, -- //ows:ServiceProvider/ows:ServiceContact/ows:ContactInfo/ows:Phone/ows:Facsimile
    -- Constraints and FKs
