...
(	serviceId	 	int IDENTITY,
	...
	-- Identity is automatically primary key. So comment it out
...
(	serviceId        int NOT NULL,
	...
	CONSTRAINT ps_servicelayer_serviceid_layerid_key
	PRIMARY KEY( serviceId, layerId ),
	CHECK( layerSeq >= 0 )
);
