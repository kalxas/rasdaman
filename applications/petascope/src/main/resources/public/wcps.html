...
<p>Enter a ProcessCoverage request in WCPS abstract syntax and submit it as a POST request with a parameter named <b>query</b>. You can use the form below.</p>
...
<!--
<p>2. Upload a ProcessCoverage XML request as a multipart/form-data POST request containing a file. You can use the form below.</p>
