...
public class TimeUtilTest {
     ...
     */
    private List<Triple<String,countOffsetInput,Double>> assertEqualsInOut;
    ...
    public void setUpTestsData() {
        ...
        assertEqualsInOut = new ArrayList<Triple<String,countOffsetInput,Double>>();
    ...
    public void testCountOffsets() throws Exception {
        ...
        for (Triple<String,countOffsetInput,Double> input : assertEqualsInOut) {
            // lo < hi
