...
/**
 * Reference interface for RasQL-related constants
 *
 * @author <a href="mailto:p.campalani@jacobs-university.de">Piero Campalani</a>
 */
public interface RasConstants {

    // Collection of constants for RasQL syntax
    ...
    public static final String RASQL_OID               = "oid";
    public static final String RASQL_POW               = "pow";
    ...
    public static final String RASQL_INTERVAL_SEPARATION = ",";
