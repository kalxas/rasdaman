    ...
    while (!feof(fp))
    {
        ...
        if ((*b != '\n') && (*b != '#') && (*b != 0))
        {
            ...
            else
            {
                ...
                {
                case PVar_ServerName:
                    serverName = val;
                    break;
                case PVar_ServerPort:
                    serverPort = atoi(val);
                    break;
                case PVar_DBName:
                    databaseName = val;
                ...
                case PVar_LastColl:
                    lastColl = val;
                    break;
                case PVar_LastScColl:
                    lastScColl = val;
                    break;
                case PVar_LastOrColl:
                    lastOrthoColl = val;
                    break;
                case PVar_LastDisp:
                    lastDisplay = atoi(val);
                    break;
                case PVar_FilePath:
                    filePath = val;
                    break;
                ...
                case PVar_MovieMode:
                    ...
                    break;
                case PVar_ImgMode:
                    imgMode = (rviewImageMode)atoi(val);
                    break;
                case PVar_ImgBBox:
                    imgBBox = atoi(val);
                    break;
                ...
                case PVar_ImgScale:
                    ...
                    break;
                case PVar_ImgPTL:
                    imgPixThreshLow = atof(val);
                    break;
                case PVar_ImgPTH:
                    imgPixThreshHigh = atof(val);
                    break;
                case PVar_ImgWT:
                    imgWgtThresh = atof(val);
                    break;
                case PVar_ImgWQ:
                    imgWgtQuant = atoi(val);
                    break;
                case PVar_ImgVoxType:
                    imgVoxForType = atoi(val);
                    break;
                case PVar_ImgRGBBr:
                    imgRgbBrightness = atoi(val);
                    break;
                case PVar_ImgLight:
                    imgLight = atoi(val);
                    break;
                case PVar_ImgLightAn:
                    imgLightAngle = atof(val);
                    break;
                case PVar_ImgLightSc:
                    imgLightScintAngle = atof(val);
                    break;
                case PVar_ImgLightAm:
                    imgLightAmbient = atof(val);
                    break;
                case PVar_ImgLightGn:
                    imgLightGain = atof(val);
                    break;
                case PVar_ImgKernSz:
                    imgKernSize = atoi(val);
                    break;
                case PVar_ImgKernTp:
                    imgKernType = atoi(val);
                    break;
                case PVar_ImgUseVCol:
                    imgUseVCol = atoi(val);
                    break;
                case PVar_ImgVoxCol:
                    imgVoxColour = atof(val);
                    break;
                case PVar_ImgLightDr:
                    imgLightDir = val;
                    break;
                case PVar_ImgLightDs:
                    imgLightDist = atoi(val);
                    break;
                case PVar_ImgHgtGrd:
                    imgHeightGrid = atoi(val);
                    break;
                case PVar_ImgHgtScl:
                    imgHeightScale = atof(val);
                    break;
                case PVar_ImgOrtBBox:
                    imgOrthoBBox = atoi(val);
                    break;
                case PVar_ImgOrtDrag:
                    imgOrthoDragRel = atoi(val);
                    break;
                case PVar_ImgOrtThick:
                    imgOrthoThick = atoi(val);
                    break;
                case PVar_ChartMode:
                    chartMode = (rviewChartMode)atoi(val);
                    break;
                case PVar_ChartCosys:
                    chartCosys = atoi(val);
                    break;
                case PVar_ChartStep:
                    chartStep = atoi(val);
                    break;
                case PVar_ChartMarkX:
                    chartMarkx = atoi(val);
                    break;
                case PVar_ChartMarkY:
                    chartMarky = atof(val);
                    break;
                case PVar_TableMode:
                    tableMode = atoi(val);
                    break;
                case PVar_TableCosys:
                    tableCosys = atoi(val);
                    break;
                case PVar_TableStepX:
                    tableStepx = atoi(val);
                    break;
                case PVar_TableStepY:
                    tableStepy = atoi(val);
                    break;
                case PVar_ThumbPDim:
                    thumbProjdim = atoi(val);
                    break;
                case PVar_ThumbPStep:
                    thumbProjstep = atoi(val);
                    break;
                case PVar_ThumbWidth:
                    thumbWidth = atoi(val);
                    break;
                case PVar_ThumbCols:
                    thumbCols = atoi(val);
                ...
                case PVar_SoundFrq:
                    ...
                    break;
                case PVar_SoundLat:
                    soundLatency = atoi(val);
                    break;
                case PVar_SoundLoop:
                    soundLoop = atoi(val);
                    break;
                case PVar_CMpeakR:
                    csp.peak_red = atof(val);
                    break;
                case PVar_CMpeakG:
                    csp.peak_green = atof(val);
                    break;
                case PVar_CMpeakB:
                    csp.peak_blue = atof(val);
                    break;
                case PVar_CMsigmR:
                    csp.sigm_red = atof(val);
                    break;
                case PVar_CMsigmG:
                    csp.sigm_green = atof(val);
                    break;
                case PVar_CMsigmB:
                    csp.sigm_blue = atof(val);
                    break;
                case PVar_CMtype:
                    csp.type = (cspaceType)atoi(val);
                    break;
                case PVar_ComTrFmt:
                    transferFmt = atoi(val);
                    break;
                case PVar_ComTrParm:
                    fromExternal(val, transferParm);
                    break;
                case PVar_ComStFmt:
                    storageFmt = atoi(val);
                    break;
                case PVar_ComStParm:
                    fromExternal(val, storageParm);
                    break;
                default:
...
int rviewPrefs::save(const char *file)
{
    ...
    for (i=0; prefsVarDesc[i].keyword != NULL; i++)
    {
        ...
        {
        case PVar_ServerName:
            fprintf(fp, "%s", serverName.ptr());
            break;
        case PVar_ServerPort:
            fprintf(fp, "%d", serverPort);
            break;
        case PVar_DBName:
            fprintf(fp, "%s", databaseName.ptr());
            break;
        case PVar_UserName:
            fprintf(fp, "%s", userName.ptr());
            break;
        case PVar_LastColl:
            fprintf(fp, "%s", lastColl.ptr());
            break;
        case PVar_LastScColl:
            fprintf(fp, "%s", lastScColl.ptr());
            break;
        case PVar_LastOrColl:
            fprintf(fp, "%s", lastOrthoColl.ptr());
            break;
        case PVar_LastDisp:
            fprintf(fp, "%d", lastDisplay);
            break;
        case PVar_FilePath:
            fprintf(fp, "%s", filePath.ptr());
            break;
        case PVar_QueryPath:
            fprintf(fp, "%s", queryPath.ptr());
            break;
        case PVar_QueryFont:
            fprintf(fp, "%s", queryFont.ptr());
            break;
        case PVar_MaxDWidth:
            fprintf(fp, "%d", maxDWidth);
            break;
        case PVar_MaxDHeight:
            fprintf(fp, "%d", maxDHeight);
            break;
        case PVar_VffParams:
            fprintf(fp, "%s", vffParams.ptr());
            break;
        case PVar_ImgDither:
            fprintf(fp, "%d", imgDither);
            break;
        case PVar_DitherBest:
            fprintf(fp, "%d", ditherBest);
            break;
        case PVar_RGBSpace:
            fprintf(fp, "%d", rgbSpace);
            break;
        case PVar_MovieMode:
            fprintf(fp, "%d", movieMode);
            break;
        case PVar_ImgMode:
            fprintf(fp, "%d", imgMode);
            break;
        case PVar_ImgBBox:
            fprintf(fp, "%d", imgBBox);
            break;
        case PVar_ImgZpro:
            fprintf(fp, "%ld", imgZpro);
            break;
        case PVar_ImgClipZ:
            fprintf(fp, "%ld", imgClipz);
            break;
        case PVar_ImgScale:
            fprintf(fp, "%f", imgScale);
            break;
        case PVar_ImgPTL:
            fprintf(fp, "%g", imgPixThreshLow);
            break;
        case PVar_ImgPTH:
            fprintf(fp, "%g", imgPixThreshHigh);
            break;
        case PVar_ImgWT:
            fprintf(fp, "%g", imgWgtThresh);
            break;
        case PVar_ImgWQ:
            fprintf(fp, "%ld", imgWgtQuant);
            break;
        case PVar_ImgRGBBr:
            fprintf(fp, "%d", imgRgbBrightness);
            break;
        case PVar_ImgVoxType:
            fprintf(fp, "%d", imgVoxForType);
            break;
        case PVar_ImgLight:
            fprintf(fp, "%d", imgLight);
            break;
        case PVar_ImgLightAn:
            fprintf(fp, "%f", imgLightAngle);
            break;
        case PVar_ImgLightSc:
            fprintf(fp, "%f", imgLightScintAngle);
            break;
        case PVar_ImgLightAm:
            fprintf(fp, "%f", imgLightAmbient);
            break;
        case PVar_ImgLightGn:
            fprintf(fp, "%f", imgLightGain);
            break;
        case PVar_ImgKernSz:
            fprintf(fp, "%d", imgKernSize);
            break;
        case PVar_ImgKernTp:
            fprintf(fp, "%d", imgKernType);
            break;
        case PVar_ImgUseVCol:
            fprintf(fp, "%d", imgUseVCol);
            break;
        case PVar_ImgVoxCol:
            fprintf(fp, "%f", imgVoxColour);
            break;
        case PVar_ImgLightDr:
            fprintf(fp, "%s", imgLightDir.ptr());
            break;
        case PVar_ImgLightDs:
            fprintf(fp, "%d", imgLightDist);
            break;
        case PVar_ImgHgtGrd:
            fprintf(fp, "%d", imgHeightGrid);
            break;
        case PVar_ImgHgtScl:
            fprintf(fp, "%f", imgHeightScale);
            break;
        case PVar_ImgOrtBBox:
            fprintf(fp, "%d", imgOrthoBBox);
            break;
        case PVar_ImgOrtDrag:
            fprintf(fp, "%d", imgOrthoDragRel);
            break;
        case PVar_ImgOrtThick:
            fprintf(fp, "%d", imgOrthoThick);
            break;
        case PVar_ChartMode:
            fprintf(fp, "%d", chartMode);
            break;
        case PVar_ChartCosys:
            fprintf(fp, "%d", chartCosys);
            break;
        case PVar_ChartStep:
            fprintf(fp, "%d", chartStep);
            break;
        case PVar_ChartMarkX:
            fprintf(fp, "%d", chartMarkx);
            break;
        case PVar_ChartMarkY:
            fprintf(fp, "%f", chartMarky);
            break;
        case PVar_TableMode:
            fprintf(fp, "%d", tableMode);
            break;
        case PVar_TableCosys:
            fprintf(fp, "%d", tableCosys);
            break;
        case PVar_TableStepX:
            fprintf(fp, "%d", tableStepx);
            break;
        case PVar_TableStepY:
            fprintf(fp, "%d", tableStepy);
            break;
        case PVar_ThumbPDim:
            fprintf(fp, "%d", thumbProjdim);
            break;
        case PVar_ThumbPStep:
            fprintf(fp, "%d", thumbProjstep);
            break;
        case PVar_ThumbWidth:
            fprintf(fp, "%d", thumbWidth);
            break;
        case PVar_ThumbCols:
            fprintf(fp, "%d", thumbCols);
            break;
        case PVar_SoundFrq:
            fprintf(fp, "%d", soundFreq);
            break;
        case PVar_SoundLat:
            fprintf(fp, "%d", soundLatency);
            break;
        case PVar_SoundLoop:
            fprintf(fp, "%d", soundLoop);
            break;
        case PVar_CMpeakR:
            fprintf(fp, "%f", csp.peak_red);
            break;
        case PVar_CMpeakG:
            fprintf(fp, "%f", csp.peak_green);
            break;
        case PVar_CMpeakB:
            fprintf(fp, "%f", csp.peak_blue);
            break;
        case PVar_CMsigmR:
            fprintf(fp, "%f", csp.sigm_red);
            break;
        case PVar_CMsigmG:
            fprintf(fp, "%f", csp.sigm_green);
            break;
        case PVar_CMsigmB:
            fprintf(fp, "%f", csp.sigm_blue);
            break;
        case PVar_CMtype:
            fprintf(fp, "%d", csp.type);
            break;
        case PVar_ComTrFmt:
            fprintf(fp, "%d", transferFmt);
            break;
        case PVar_ComTrParm:
        {
...
void rviewPrefs::setupVariables(void)
{
    ...
    imgScale = 1.0;
    imgPixThreshLow = 4.0;
    imgPixThreshHigh = 1e6;
    imgWgtThresh = 64.0;
    imgWgtQuant = 4;
    imgRgbBrightness = TRUE;
    imgVoxForType = TRUE;
    imgLight = FALSE;
    imgLightAmbient = 0.5;
    imgLightGain = 1.0;
    imgLightAngle = 90.0;
    imgLightScintAngle = 90.0;
    imgKernSize = 2;
    imgKernType = 2;
    imgUseVCol = FALSE;
    imgVoxColour = 255.0;
...
void rviewPrefsWindow::setPrefs(rviewPrefs *Prefs)
{
    ...
    {
    case rim_voxel:
        imgMode->SetSelection(1);
        break;
    default:
        imgMode->SetSelection(0);
        break;
    }
    switch (editPrefs->chartMode)
    {
    case rcm_line:
        chartMode->SetSelection(1);
        break;
    case rcm_spline:
        chartMode->SetSelection(2);
        break;
    default:
        chartMode->SetSelection(0);
        break;
    }
    switch (editPrefs->tableMode)
    {
    case 8:
        tableMode->SetSelection(1);
        break;
    case 16:
        tableMode->SetSelection(2);
        break;
    default:
        tableMode->SetSelection(0);
        break;
    }
...
void rviewPrefsWindow::updatePrefs(void)
{
    ...
    {
    case 1:
        editPrefs->imgMode = rim_voxel;
        break;
    default:
        editPrefs->imgMode = rim_surf;
        break;
    }
    switch (chartMode->GetSelection())
    {
    case 1:
        editPrefs->chartMode = rcm_line;
        break;
    case 2:
        editPrefs->chartMode = rcm_spline;
        break;
    default:
        editPrefs->chartMode = rcm_bar;
        break;
    }
    switch (tableMode->GetSelection())
    {
    case 1:
        editPrefs->tableMode = 8;
        break;
    case 2:
        editPrefs->tableMode = 16;
        break;
    default:
        editPrefs->tableMode = 10;
        break;
    }
    if (csmap != NULL)
    {
