...
CREATE TABLE ps9_domain_set (
    ...
    -- Constraints and FKs
    FOREIGN KEY (coverage_id)   REFERENCES ps9_coverage (id) ON DELETE CASCADE,
    FOREIGN KEY (native_crs_id) REFERENCES ps9_crs      (id) ON DELETE RESTRICT
);
...
-- GML coverage types:
INSERT INTO ps9_gml_subtype (subtype) VALUES ('GridCoverage');
INSERT INTO ps9_gml_subtype (subtype, subtype_parent) 
       VALUES ('RectifiedGridCoverage',     (SELECT id FROM ps9_gml_subtype WHERE subtype='GridCoverage'));
INSERT INTO ps9_gml_subtype (subtype, subtype_parent) 
       VALUES ('ReferenceableGridCoverage', (SELECT id FROM ps9_gml_subtype WHERE subtype='GridCoverage'));
