...
/**
 * BaseX backend. Run query with userdb and gml_* dictionaries file.
 *
 * @author Dimitar Misev
 */
public class BaseX implements Database {

    private static final Logger log = LoggerFactory.getLogger(BaseX.class);
    ...
    public void close() {
        try {
            ...
            log.error("Cannot close BaseX context", ex);
        }
    }
     ...
     *
     * @param query Xquery
     * @param collectionName the database name of the collection should be
     * queried (e.g: gml_85 or userdb)
     * @return String
     ...
     * @param collectionName collection name of dictionary which want to query
     * (e.g: userdb, gml_8.5)
    ...
    public String queryEpsg(String query, String versionNumber) throws SecoreException {
        ...
        log.debug("Executing query against the EPSG database: " + query);
