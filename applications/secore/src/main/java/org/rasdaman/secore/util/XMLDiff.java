...
class IgnoreNamedElementsDifferenceListener implements DifferenceListener {
    ...
    private static final Logger log = LoggerFactory.getLogger(IgnoreNamedElementsDifferenceListener.class);

    private Set<String> ignoreElements = new HashSet<>();
    private Set<String> ignoreAttributes = new HashSet<>();
