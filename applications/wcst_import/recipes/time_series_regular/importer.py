...
class Importer:
    def __init__(self, timeseries, time_step, coverage_id, time_crs, crs_resolver, default_crs, util,
        ...
        :param float time_step: the time
    ...
    def create_init_gml_file(self, time_tuple):
        ...
        insert_gml = Generator(self.util, self.coverage_id, time_tuple.filepath, self.crs_resolver, self.default_crs,
                               self.time_crs, time_tuple.time, self.time_step).to_file()
        return insert_gml
