...
{
/**
 * @brief The UserAlreadyExistsException class defines a type of object to be thrown as exception.
 *  It reports errors that arise because a user tries to create a user with the same name as an existing user.
 */
...
#endif /* RASMGR_X_SRC_EXCEPTIONS_USERALREADYEXISTSEXCEPTION_HH_ */
