...
#ifndef RASMGR_X_SRC_EXCEPTIONS_INEXISTENDDATABASEEXCEPTION_HH
#define RASMGR_X_SRC_EXCEPTIONS_INEXISTENDDATABASEEXCEPTION_HH
 ...
 */
class InexistentDatabaseException: public common::MissingResourceException
{
public:
