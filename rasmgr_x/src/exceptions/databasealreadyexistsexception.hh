...
#ifndef RASMGR_X_SRC_EXCEPTIONS_DATABASEALREADYEXISTSEXCEPTION_HH
#define RASMGR_X_SRC_EXCEPTIONS_DATABASEALREADYEXISTSEXCEPTION_HH
...
public:
    /**
     * @brief DatabaseAlreadyExistsException
    ...
    virtual ~DatabaseAlreadyExistsException();
};
}
