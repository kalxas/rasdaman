...
{
/**
 * @brief The InexistentUserException class defines a type of object to be thrown as exception.
 *  It reports errors that arise because a user tried to operate on a user object that does not exist.
 */
...
public:
    ...
    virtual ~InexistentUserException() throw();
};

} /* namespace rasmgr */

#endif /* RASMGR_X_SRC_EXCEPTIONS_INEXISTENTUSEREXCEPTION_HH_ */
