...
{
/**
 * @brief The DbHostBusyException class defines a type of object to be thrown as exception.
...
public:
    ...
    virtual ~DbHostBusyException();
};

} /* namespace rasmgr */

#endif /* RASMGR_X_SRC_EXCEPTIONS_DBHOSTBUSYEXCEPTION_HH_ */
