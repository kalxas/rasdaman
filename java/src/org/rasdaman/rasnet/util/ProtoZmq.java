...
public class ProtoZmq {
    ...
    public static String receiveFromPeer(ZMQ.Socket source, ContainerMessage outMessage) throws InvalidProtocolBufferException, NetworkingException {
        boolean success = true;
    ...
    public static void receive(ZMQ.Socket source, ContainerMessage outMessage) throws InvalidProtocolBufferException, NetworkingException {
