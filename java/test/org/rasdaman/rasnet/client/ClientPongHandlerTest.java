...
public class ClientPongHandlerTest {
    @Rule
    public ExpectedException thrown = ExpectedException.none();

    private PeerStatus serverStatus;
    private ClientPongHandler pongHandler;

    @Before
    public void setUp() {
        this.serverStatus = mock(PeerStatus.class);
        this.pongHandler = new ClientPongHandler(serverStatus);
    }
    ...
    public void testHandle() throws Exception {
        ...
        pongHandler.handle(goodMessage);
