...
MERCHANTABILITY or FITNESS FOR A PAR­TIC­UL­AR PURPOSE. See the GNU
General Public License for more details.

You should have received a copy of the GNU General Public License along
with rasdaman. If not, see
`www.gnu.org/licenses <http://www.gnu.org/licenses>`__. For more
information please see `www.rasdaman.org <http://www.rasdaman.org>`__ or
contact Peter Baumann via baumann@rasdaman.com.

Originally created by rasdaman GmbH, this document is published under a
...
.. toctree::
   ...
   03_contributing.rst
   04_ql-guide.rst
   05_geo-services-guide.rst
   06_crs-manager.rst
   07_rrasdaman-guide.rst
